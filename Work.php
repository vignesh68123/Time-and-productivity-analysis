...
Project Title:<br>
<textarea name="ProjectTitle" rows="1" cols="25" required></textarea>
</br>
Description:<br>
<textarea name="Description" rows="1" cols="50" required></textarea>
</br>
Start Time:<br>
<input type="datetime-local" id="StartTime"
       name="StartTime" value="0000-00-00T19:30"
       min="2019-01-01T00:00" max="2019-12-31T00:00" required>
	   </br>
End Time:<br>
<input type="datetime-local" id="EndTime"
       name="EndTime" value="0000-00-00T19:30"
       min="2019-01-01T00:00" max="2019-12-31T00:00" required></br>
Status:<br>
<select name="Status">
<option value="">--SELECT--</option>
